...
function Alantic(){
    return(
        ...
        <CssBaseline/>
                    ...
                    <Grid item xs={12} md={6} lg={2} >
                        <Card sx={{ minWidth: 275 }}>
                            <CardContent>
                                ...
                                <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={316} duration={2}/>  ppm by volume</p>
                            </CardContent>
                        </Card>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6} lg={2}>
                        <Card sx={{ minWidth: 275 }}>
                            <CardContent>
                                ...
                                <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={200} duration={2}/> million tonnes</p>
                            </CardContent>
                        </Card>
                    </Grid>
                    ...
                    <Grid item xs={12} md={6} lg={2}>
                        <Card sx={{ minWidth: 275 }}>
                            <CardContent>
                                ...
                                <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={3000} duration={2}/> Known Species</p>
                            </CardContent>
                        </Card>
                    </Grid>  
                </Grid>
            ...
            <Typography variant="h4" style={{marginTop:"50px",marginLeft:"40px"}}>
                 Want To Help?
            </Typography>
