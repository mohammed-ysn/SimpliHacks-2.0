            ...
            <Grid container justifyContent="center" spacing={3} style={{marginTop:"15px"}}>
                    ...
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                            ...
                            <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={38000} duration={2} separator=","/> gigatons</p>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6} lg={2}>
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                            ...
                            <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={80000} duration={2} separator=","/> tonnes</p>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6} lg={2}>
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                            ...
                            <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={228450} duration={2} separator=","/> Known Species</p>
                        </CardContent>
                    </Card>
                </Grid>  
            </Grid>
