                ...
                <Grid item xs={12} md={6} lg={2} >
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                            ...
                            <p style={{fontWeight: 400,fontSize: 16 }}> N/A ppm by volume</p>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6} lg={2}>
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                            ...
                            <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={15} duration={2} separator=","/> million Tons</p>
                        </CardContent>
                    </Card>
                </Grid>
                ...
                <Grid item xs={12} md={6} lg={2}>
                    <Card sx={{ minWidth: 275 }}>
                        <CardContent>
                            ...
                            <p style={{fontWeight: 400,fontSize: 16 }}><CountUp start={0} end={2200} duration={2} separator=","/> Known Species</p>
                        </CardContent>
                    </Card>
                </Grid>  
            </Grid>
